...
def run_client(token):
    ...
    async def on_message(message):
        ...
        if cmd == ">fin":
            ...
            REACT_USER_ID = None
            REACT_EMOJI = None
            await message.channel.send(" arret...")
            ...
            try:
                ...
                await message.channel.send(" Failed to purge.")
                print(f" {e}")
...
"""
            ...
            try:
                ...
                await message.channel.send(" Failed to set playing status.")
            ...
            try:
                ...
                await message.channel.send(" Failed to set watching status.")
            ...
            try:
                ...
                await message.channel.send(" Failed to set listening status.")
